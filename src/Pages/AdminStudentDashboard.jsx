...
export default function AdminStudentDashboard() {
  ...
  return <main className="student-record-shell">
    <header className="record-school-bar"><img src={student.school_logo || activeSchool.school_logo || "/brand-mark.svg"} alt="School logo"/><div><small>SCHOOL STUDENT RECORD · CODE {student.school_code}</small><h2>{student.school_name || activeSchool.school_name}</h2></div><School/></header>
    ...
    <footer className="record-footer"><GraduationCap/> All information is linked to {student.school_name || activeSchool.school_name}.</footer>
