...
export type Fee = { id?: string; student_id: string; school_code?: string; month: string; status: string; amount?: number | string; due_amount?: number | string; paid_at?: string; fee_type?: 'monthly' | 'exam'; exam_fee_id?: string; title?: string };
